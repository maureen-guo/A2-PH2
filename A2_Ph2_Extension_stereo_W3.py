...
def main():
    ...
    for iteration in range(15):
        ...
        H3_pixel_size = (W3_pixel_size_x + W3_pixel_size_y) / 2
        dx = dy = H3_pixel_size
 
        xu_left, yu_left = A2_uti.calculate_undistorted_coordinates(xu_W3_left, yu_W3_left, cx, cy, W3_pixel_size_x, W3_pixel_size_y,sx=1)
        xu_right, yu_right = A2_uti.calculate_undistorted_coordinates(xu_W3_right, yu_W3_right, cx2, cy2, W3_pixel_size_x, W3_pixel_size_y,sx=1)
        ...
        r_values, tx, ty, tz, f_left, xu_left, yu_left= A2_uti.calculate_matrices_and_focal_length(L_left, xu_W3_left, yu_W3_left, X_left, Y_left, Z_left, dx, dy, cx, cy, X_ref_h, Y_ref_h, Z_ref_h, x_ref_h, y_ref_h)
        ...
        #calculate the error in cube in left image of W3
        ...
        W3_points_left = W3_points_left.drop(W3_points_left.index[max_error_index])
        ...
        r_values, tx, ty, tz, f_right, xu_right, yu_right = A2_uti.calculate_matrices_and_focal_length(L_right, xu_W3_right, yu_W3_right, X_right, Y_right, Z_right, dx, dy, cx2, cy2, X_ref_h_right, Y_ref_h_right, Z_ref_h_right, x_ref_h_right, Y_ref_h_right)
        ...
        #calculate the error in cube in the right image of W3
        ...
        # Drop the point with the largest error
        W3_points_right = W3_points_right.drop(W3_points_right.index[max_error_index])
